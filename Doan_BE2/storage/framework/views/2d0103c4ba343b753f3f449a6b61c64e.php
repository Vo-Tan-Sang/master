                                    ...
                                    <div class="mega-content">
                                        <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                            <div class="wrap-custom-menu vertical-menu">
                                                <h4 class="menu-title">Sản Phẩm</h4>
                                                <ul class="menu">
                                                    <li><a href="<?php echo e(route('index')); ?>">Áo</a></li>
                                                    <li><a href="">Quần</a></li>
                                                    <li><a href="#">Cặp</a></li>
    ...
    </header><?php /**PATH C:\wamp64\www\demo\resources\views/Frontend/layouts/header.blade.php ENDPATH**/ ?>