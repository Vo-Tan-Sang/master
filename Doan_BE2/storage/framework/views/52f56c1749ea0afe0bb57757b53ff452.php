					...
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="single-item-body">
                                <b><?php echo e($product->tag); ?></>
								<p class="single-item-title"><?php echo e($product->name); ?></p>
								<p class="single-item-price">
                                    <?php if($product -> discount != null): ?>
									<h5><b>Sale:$<?php echo e($product->discount); ?></b></h5>
                                    <b>GiáGốc: $<?php echo e($product->price); ?></b>
                                    <?php else: ?>                                 
...
<?php /**PATH C:\wamp64\www\demo\resources\views/Frontend/shop/show.blade.php ENDPATH**/ ?>