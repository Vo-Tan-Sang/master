				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
								<li><a href="shop/sp/<?php echo e(1); ?>">Áo</a></li>
								<li><a href="shop/sp/<?php echo e(2); ?>">Quần</a></li>
								<li><a href="shop/sp/<?php echo e(3); ?>">Balo</a></li>
								<li><a href="shop/sp/<?php echo e(4); ?>">Khăn Cổ</a></li>
							</ul>
						</li>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="row">
							<?php $__currentLoopData = $womenProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $womenProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-sm-3">
									<div class="single-item">
										<?php if($womenProduct->discount != null): ?>
										<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div>
										<?php endif; ?>
									</div>

										<div class="single-item-header">
											<a href="product.html"><img src="front/img/products/<?php echo e($womenProduct->productImages[0]->path); ?>" alt=""></a>
										</div>
										<div class="single-item-body">
										<p class="single-item-title"><?php echo e($womenProduct->tag); ?></p>
											<p class="single-item-title"><?php echo e($womenProduct->name); ?></p>
											<p class="single-item-price">
											<?php if($womenProduct->discount != null): ?>
												<span class="flash-del">$<?php echo e($womenProduct->discount); ?></span>
												<span class="flash-sale">$<?php echo e($womenProduct->price); ?></span>
												<?php else: ?>
												$<?php echo e($womenProduct->price); ?>
						...
						<div class="beta-products-list">
							...
							<div class="row">								
							<?php $__currentLoopData = $menProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-sm-3">
									<div class="single-item">
										<?php if($menProduct->discount != null): ?>
										<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div>
										<?php endif; ?>
									</div>

										<div class="single-item-header">
											<a href="product.html"><img src="front/img/products/<?php echo e($menProduct->productImages[0]->path); ?>" alt=""></a>
										</div>
										<div class="single-item-body">
										<p class="single-item-title"><?php echo e($menProduct->tag); ?></p>
											<p class="single-item-title"><?php echo e($menProduct->name); ?></p>
											<p class="single-item-price">
											<?php if($womenProduct->discount != null): ?>
												<span class="flash-del">$<?php echo e($menProduct->discount); ?></span>
												<span class="flash-sale">$<?php echo e($menProduct->price); ?></span>
												<?php else: ?>
												$<?php echo e($menProduct->price); ?>
...
</html><?php /**PATH C:\wamp64\www\demo\resources\views/Frontend/index.blade.php ENDPATH**/ ?>